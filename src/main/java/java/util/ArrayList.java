...
public class ArrayList<E> extends AbstractCollection<E> implements List<E> {
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof ArrayList)) return false;
    ...
    public int indexOf(Object elem) {
        for (int i=start; i<end; i++) {
            if (elem.equals(array[i])) return i-start;
        }
        return -1;
    }
    ...
    public int lastIndexOf(Object elem) {
        for (int i=end; i>=start; i--) {
            // TODO: Do we have to use equals()?
            if (elem == array[i]) return i - start;
        }
        return -1;
    }
    ...
    private void incEnd(int count) {
        ...
        if (backingList != null) backingList.incEnd(count);
    }

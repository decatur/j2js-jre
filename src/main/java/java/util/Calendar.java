...
*/
    ...
    public final int get(int field) {
        ...
        ScriptHelper.put("functionName", "get" + functionName);
        int value = ScriptHelper.evalInt("this.date.nativeDate[functionName]()");
    ...
    public final void set(int field, int value) {
        ...
        ScriptHelper.put("functionName", "set" + functionName);
        ScriptHelper.eval("this.date.nativeDate[functionName](value)");   
    }
